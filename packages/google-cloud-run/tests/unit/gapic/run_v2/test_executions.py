...
from google.cloud.run_v2.services.executions import (
...
from google.cloud.run_v2.types import Execution, ListExecutionsRequest, ListExecutionsResponse
...
def test_executions_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.run_v2.services.executions.transports.ExecutionsGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_get_execution_async(
    transport: str = "grpc_asyncio", request_type=execution.GetExecutionRequest
):
    client = ExecutionsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_list_executions_async(
    transport: str = "grpc_asyncio", request_type=execution.ListExecutionsRequest
):
    client = ExecutionsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_delete_execution_async(
    transport: str = "grpc_asyncio", request_type=execution.DeleteExecutionRequest
):
    client = ExecutionsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_cancel_execution_async(
    transport: str = "grpc_asyncio", request_type=execution.CancelExecutionRequest
):
    client = ExecutionsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_execution_rest(request_type):
    ...
    request_init = {
        "name": "projects/sample1/locations/sample2/jobs/sample3/executions/sample4"
    }
...
def test_get_execution_rest_interceptors(null_interceptor):
    transport = transports.ExecutionsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.ExecutionsRestInterceptor(),
    )
...
def test_get_execution_rest_bad_request(
    transport: str = "rest", request_type=execution.GetExecutionRequest
):
    client = ExecutionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_execution_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/jobs/*/executions/*}"
...
def test_list_executions_rest_required_fields(
    request_type=execution.ListExecutionsRequest,
):
    transport_class = transports.ExecutionsRestTransport
...
def test_list_executions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = execution.ListExecutionsResponse.to_json(
            execution.ListExecutionsResponse()
        )
...
def test_list_executions_rest_bad_request(
    transport: str = "rest", request_type=execution.ListExecutionsRequest
):
    client = ExecutionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_executions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*/jobs/*}/executions"
            % client.transport._host,
            args[1],
        )
...
def test_delete_execution_rest_required_fields(
    request_type=execution.DeleteExecutionRequest,
):
    transport_class = transports.ExecutionsRestTransport
...
def test_delete_execution_rest_bad_request(
    transport: str = "rest", request_type=execution.DeleteExecutionRequest
):
    client = ExecutionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_cancel_execution_rest_required_fields(
    request_type=execution.CancelExecutionRequest,
):
    transport_class = transports.ExecutionsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).cancel_execution._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_execution_rest_bad_request(
    transport: str = "rest", request_type=execution.CancelExecutionRequest
):
    client = ExecutionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_cancel_execution_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/jobs/*/executions/*}:cancel"
            % client.transport._host,
            args[1],
        )
...
def test_executions_base_transport():
    ...
    with mock.patch(
        "google.cloud.run_v2.services.executions.transports.ExecutionsTransport.__init__"
    ) as Transport:
...
def test_executions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.run_v2.services.executions.transports.ExecutionsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_list_executions_request_filter_sort_by():
    ...
    mock_response = ListExecutionsResponse(
        executions=[
            Execution(name="projects/my-project/locations/us-central1/jobs/my-job/executions/execution2"),
            Execution(name="projects/my-project/locations/us-central1/jobs/my-job/executions/execution1"),
        ],
        next_page_token=""
    )
    
    # Mock the client and the list_executions method
    with mock.patch.object(ExecutionsClient, 'list_executions', return_value=mock_response) as mock_list_executions:
        ...
        assert isinstance(response, ListExecutionsResponse), f"Expected ListExecutionsResponse, got {type(response)}"

        # Ensure the response content matches the mock response
        assert len(response.executions) == 2, f"Expected 2 executions, got {len(response.executions)}"
        assert response.executions[0].name == 'projects/my-project/locations/us-central1/jobs/my-job/executions/execution2', f"Unexpected execution name: {response.executions[0].name}"
        assert response.executions[1].name == 'projects/my-project/locations/us-central1/jobs/my-job/executions/execution1', f"Unexpected execution name: {response.executions[1].name}"

        # Further assertions can be made here based on expected response behavior
        mock_list_executions.assert_called_once_with(request=request)
...
async def test_list_executions_request_filter_sort_by_async():
    ...
    # Mock the client and the list_executions method
    with mock.patch.object(ExecutionsAsyncClient, 'list_executions', return_value=mock_response) as mock_list_executions:
