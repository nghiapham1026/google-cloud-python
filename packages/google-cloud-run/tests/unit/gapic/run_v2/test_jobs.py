...
from google.cloud.run_v2.services.jobs import (
    JobsAsyncClient,
    JobsClient,
    pagers,
    transports,
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        JobsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    )
    assert (
        JobsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
...
def test__get_client_cert_source():
    ...
    assert (
        JobsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                JobsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(JobsClient),
)
@mock.patch.object(
    JobsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(JobsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = JobsClient._DEFAULT_UNIVERSE
    default_endpoint = JobsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = JobsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == JobsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        JobsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        JobsClient._get_api_endpoint(None, None, default_universe, "always")
        == JobsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        JobsClient._get_api_endpoint(
    ...
    assert (
        JobsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        JobsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        JobsClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        JobsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
...
def test_jobs_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [JobsClient, JobsAsyncClient])
@mock.patch.object(JobsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(JobsClient))
@mock.patch.object(
    JobsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(JobsAsyncClient)
)
...
def test_jobs_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_jobs_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_jobs_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.run_v2.services.jobs.transports.JobsGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = JobsClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_jobs_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_create_job_async(
    transport: str = "grpc_asyncio", request_type=gcr_job.CreateJobRequest
):
    client = JobsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_get_job_async(
    transport: str = "grpc_asyncio", request_type=job.GetJobRequest
):
    client = JobsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_list_jobs_async(
    transport: str = "grpc_asyncio", request_type=job.ListJobsRequest
):
    client = JobsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_update_job_async(
    transport: str = "grpc_asyncio", request_type=gcr_job.UpdateJobRequest
):
    client = JobsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_delete_job_async(
    transport: str = "grpc_asyncio", request_type=job.DeleteJobRequest
):
    client = JobsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_run_job_async(
    transport: str = "grpc_asyncio", request_type=job.RunJobRequest
):
    client = JobsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_job_rest_bad_request(
    transport: str = "rest", request_type=gcr_job.CreateJobRequest
):
    client = JobsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*}/jobs" % client.transport._host,
            args[1],
        )
...
def test_get_job_rest_bad_request(
    transport: str = "rest", request_type=job.GetJobRequest
):
    client = JobsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/jobs/*}" % client.transport._host,
            args[1],
        )
...
def test_list_jobs_rest_bad_request(
    transport: str = "rest", request_type=job.ListJobsRequest
):
    client = JobsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{job.name=projects/*/locations/*/jobs/*}" % client.transport._host,
            args[1],
        )
...
def test_delete_job_rest_bad_request(
    transport: str = "rest", request_type=job.DeleteJobRequest
):
    client = JobsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_run_job_rest_bad_request(
    transport: str = "rest", request_type=job.RunJobRequest
):
    client = JobsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_run_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/jobs/*}:run" % client.transport._host,
            args[1],
        )
...
def test_jobs_base_transport():
    ...
    with mock.patch(
        "google.cloud.run_v2.services.jobs.transports.JobsTransport.__init__"
    ) as Transport:
...
def test_jobs_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.run_v2.services.jobs.transports.JobsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    "transport_class",
    [transports.JobsGrpcTransport, transports.JobsGrpcAsyncIOTransport],
)
def test_jobs_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_jobs_transport_channel_mtls_with_client_cert_source(transport_class):
    with mock.patch(
...
def test_jobs_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
